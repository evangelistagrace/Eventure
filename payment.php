...
<body>
    ...
    <!--Content-->
    <section>
        <div class="section-title text-center">Payment</div>
        <div class="row">
            <div class="col">
                <div class="payment form-container">
                    ...
                    <?php include('errors.php') ?>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-12">
                                    <input type="text" class="form-control" placeholder="Card Number" name="cardNum" required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <input type="text" class="form-control mb-3" placeholder="Address line 1" name="address" required>
                                    <input type="text" class="form-control mb-3" placeholder="Address line 2">
